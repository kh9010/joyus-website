...
| 6 | **Rework the bottom of the home page — the "pulling" line** (`index.html`) | ☐ | The animated tagline at the bottom of the homepage ("tell us what's pulling on you") — Kahran to rework that line/section. (Clarified by Divya 2026-06-03: this is the homepage pulling line, NOT a footer / closing-pattern rework.) |
